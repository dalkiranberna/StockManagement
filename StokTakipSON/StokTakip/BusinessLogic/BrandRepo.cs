...
namespace StokTakip.BusinessLogic
{
    class BrandRepo 
    {
        ...
        {
            Program.SqlHelper.ExecuteCommand(@"IF NOT EXISTS(SELECT * FROM Brands WHERE BrandName = '" + newBrand.BrandName + "') INSERT INTO Brands (BrandName) VALUES ('" + newBrand.BrandName + "')");
        }
